...
export async function generateMetadata({ params }) {
  ...
  return {
    title: {
      absolute: product.metaTitle || `${product.name} Supplier Hyderabad | Surravi Phharma`,
    },
...
export default async function ProductPage({ params }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: product.categoryLabel, item: `${SITE.url}/products/${product.category}` },
      { '@type': 'ListItem', position: 4, name: product.name, item: `${SITE.url}/products/${product.category}/${product.slug}` },
    ],
  };
          ...
          <div className="product-layout">
            ...
            <div className="product-main">
              ...
              {product.specs && Object.keys(product.specs).length > 0 && (
                <details className="product-section product-foldout">
              ...
              <details className="product-section product-foldout why-box">
                <summary>Why Source from Surravi Phharma?</summary>
                <ul>
            ...
            <aside className="product-sidebar">
              <div className="sidebar-card">
                ...
                <EnquiryForm
                  ...
                  productDescription={product.overview || product.metaDescription || ''}
                />
              </div>
