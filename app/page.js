...
const CATEGORY_IMAGES = {
  ...
  'empty-capsules': '/images/categories/capsules.webp',
  'excipients': '/images/categories/excipients.webp',
  'vitamins': '/images/categories/vitamins.webp',
  'colours': '/images/categories/colours.webp',
  'phosphates': '/images/categories/phosphates.webp',
  'oils-butters': '/images/categories/oils.webp',
  'amino-acids': '/images/categories/amino.webp',
  'food-nutra': '/images/categories/nutra.webp',
  'nutraceuticals': '/images/categories/nutraceuticals.webp',
  'food': '/images/categories/food.webp',
  'flavours': '/images/categories/flavours.webp',
};

export const metadata = {
  title: {
    absolute: 'Surravi Phharma | Pharma, Nutra & Food Raw Materials Hyderabad',
  },
  description:
        ...
        <div className="container">
          ...
          <div className="cat-grid-v2">
            {categories.map((cat) => {
              ...
              const image = CATEGORY_IMAGES[cat.category];
              const icon = cfg?.icon ?? '🔬';
